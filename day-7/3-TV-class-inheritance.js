...
console.log(a.increaseVolume()); // => Panasonic at channel 1, volume 51
console.log(a.decreaseVolume()); // => Panasonic at channel 1, volume 50
console.log(a.increaseVolume()); // => Panasonic at channel 1, volume 51
console.log(a.setChannel(23)); // => Panasonic at channel 23, volume 51
console.log(a.setChannel(85)); // => Panasonic at channel 23, volume 51
console.log(a.resetTV()); // => Panasonic at channel 1, volume 50
